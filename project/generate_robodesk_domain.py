    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                (
                    "(forall (?obj - Item)\
                             (not (InGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{}:{}".format(0, 0),
                ),
    ...
    def __init__(self, arm):
        ...
        self.eff.extend(
            [  # ('(RightGripperDownRot ?robot)', '{0}:{1}'.format(3, self.end-1)),
                (
                    "(NearApproach{} ?robot ?item)".format(arm),
                ...
                (
                    "(forall (?obj - Item / ?item) (not (EEAtXY{} ?robot ?obj)))".format(
                        arm
                    ),
                ...
                (
                    "(forall (?obj - Target / ?targ) (not (EEAtXY{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Item / ?item) (not (NearApproach{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Target) (not (NearApproach{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Reachable) (not (NearGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Reachable) (not (InGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
class MoveHolding(Action):
    def __init__(self):
        ...
        self.pre = [  # ('(RobotAt ?robot ?start)', '0:-1'),
            ...
            # ('(not (RSelfCollides ?robot))', '0:{}'.format(end)),
            (
                "(forall (?obs - Obstacle) (not (RCollides ?robot ?obs)))",
                "1:{}".format(end - 1),
            ),
        ]
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                    "{0}:{1}".format(1, self.end),
                ),
            ]
        )
...
class MoveToPutdownArm(MoveHoldingArm):
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ("(forall (?obj - Item) (not (At ?obj ?targ)))", "0:0"),
                ("(forall (?obj - Item) (not (Near ?obj ?targ)))", "0:0"),
                (
                    "({}GripperDownRot ?robot)".format(arm),
                    "{0}:{1}".format(1, self.end - 1),
                ),
        ...
        self.eff.extend(
            [
                (
                    "(NearApproach{} ?robot ?targ)".format(arm),
                    "{0}:{1}".format(self.end, self.end),
                ),
                (
                    "(EEAtXY{} ?robot ?targ)".format(arm),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Item / ?item) (not (EEAtXY{} ?robot ?obj)))".format(
                ...
                (
                    "(forall (?reach - Item) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?reach - Target / ?targ) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
class Grasp(Action):
    def __init__(self):
        ...
        self.pre = [
            ...
            (
                "(forall (?obs - Obstacle) (not (RCollides ?robot ?obs)))",
                "1:{}".format(self.grasp_time - steps),
            ),
            (
                "(forall (?obs - Obstacle) (not (RCollides ?robot ?obs)))",
            ...
            (
                "(forall (?obj - Item) (not (Obstructs ?robot ?obj)))",
                "1:{}".format(grasp_time - 3),
            ),
            (
                "(forall (?obj - Item) (not (ObstructsHolding ?robot ?obj ?item)))",
        ...
        self.eff = [  # ('(not (At ?item ?target))', '{}:{}'.format(end, end-1)) ,
            ...
            (
                "(forall (?obj - Item) (not (ObstructsHolding ?robot ?item ?obj)))",
                "{}:{}".format(end, end - 1),
            ),
        ]
...
class GraspArm(Grasp):
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    ...
                    "{}:{}".format(self.grasp_time - steps, self.grasp_time + steps),
                ),
                (
                ...
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                    "{0}:{1}".format(self.grasp_time, self.end - 1),
                ),
                (
                    "({}GripperDownRot ?robot)".format(arm),
                    "{0}:{1}".format(1, self.end - 1),
                ...
                (
                    "(forall (?obj - Item) (not (InGripper{} ?robot ?item)))".format(
                        arm
                    ),
                    "0:0",
                ),
                (
                    "(forall (?obj - Item) (not (NearGripper{} ?robot ?item)))".format(
                        arm
                    ),
                    "0:0",
                ),
        ...
        self.eff.extend(
            [
                (
                    "(InGripper{} ?robot ?item)".format(arm),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                ...
                (
                    "(not (NearApproach{} ?robot ?item))".format(arm),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
            ]
        )
...
class PutdownArm(Putdown):
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ("(NearApproach{} ?robot ?target)".format(arm), "0:0"),
                ("(NearGripper{} ?robot ?item)".format(arm), "0:0"),
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                    "1:{}".format(self.putdown_time),
                ),
                (
                ...
                (
                    "(EEAt{}Rot ?robot ?target)".format(arm),
                    "{}:{}".format(
                        self.putdown_time - self.steps, self.putdown_time + self.steps
                    ),
                ),
                (
                    "(EEAtXY{} ?robot ?target)".format(arm),
        ...
        self.eff.extend(
            [
                ...
                (
                    "(forall (?obj - Item) \
                             (not (NearGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end),
                ),
                ...
                (
                    "(NearApproach{} ?robot ?target)".format(arm),
                    "{0}:{1}".format(self.end, self.end),
                ),
                (
                    "(forall (?obj - Item / ?item) (not (EEAtXY{} ?robot ?obj)))".format(
                ...
                (
                    "(forall (?obj - Target / ?target) (not (EEAtXY{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?reach - Item / ?item) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?reach - Target / ?target) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
class Hold(Action):
    def __init__(self):
        ...
        self.pre = [  # ('(At ?item ?target)', '0:0'),
            ...
            (
                "(forall (?obs - Obstacle) (not (RCollides ?robot ?obs)))",
                "1:{}".format(self.grasp_time - steps - 1),
            ),
            # ('(forall (?w - Obstacle) (not (RCollides ?robot ?w)))', '{}:{}'.format(0, 0)),
            (
                "(forall (?obj - Item) (not (Obstructs ?robot ?obj)))",
                "1:{}".format(grasp_time - steps),
            ),
            # ('(forall (?obj - Item) (not (Obstructs ?robot ?obj)))', '0:0'),
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    ...
                    "{}:{}".format(self.grasp_time - 3, self.grasp_time - 1),
                ),
                (
                    "(OpenGripper{} ?robot)".format(arm),
                    "{0}:{1}".format(1, self.end - 1),
                ...
                (
                    "(forall (?obj - Item) (not (InGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "0:{}".format(-1),
                ),
                (
                    "(forall (?obj - Item) (not (NearGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "0:-1",
                ),
        ...
        self.eff.extend(
            [
                ...
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                    "{0}:{1}".format(self.grasp_time, self.end),
                ),
                (
                    "(forall (?obj - Item / ?item) (not (NearGripper{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                ...
                (
                    "(forall (?reach - Reachable) (not (Approach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?reach - Reachable) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    "(EEAtYRel{} ?robot ?item)".format(arm),
                    "{}:{}".format(
                        self.grasp_time - steps - 3, self.grasp_time - steps - 1
                    ),
                ),
                (
                    "(EEApproachAbs{} ?robot ?item)".format(arm),
                    "{}:{}".format(self.grasp_time, self.grasp_time),
                ),
                (
                    "(EEAt{}Rot ?robot ?item)".format(arm),
                    "{}:{}".format(self.grasp_time - steps - 2, self.grasp_time),
                ),
                (
                    "(OpenGripper{} ?robot)".format(arm),
                    "{0}:{1}".format(1, self.grasp_time),
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    "(EEAtYRel{} ?robot ?item)".format(arm),
                    "{}:{}".format(self.grasp_time - steps - 3, self.grasp_time),
                ),
                # ('(EEApproachAbs{} ?robot ?item)'.format(arm), '{}:{}'.format(self.grasp_time, self.grasp_time)),
                (
                    "(EEApproach{} ?robot ?item)".format(arm),
                ...
                (
                    "(EEAt{}Rot ?robot ?item)".format(arm),
                    "{}:{}".format(self.grasp_time - steps, self.grasp_time),
                ),
                (
                    "(OpenGripper{} ?robot)".format(arm),
                    "{0}:{1}".format(1, self.grasp_time),
...
class Lift(Action):
    def __init__(self):
        ...
        self.pre = [
            (
                "(forall (?door - Door) (not (SlideDoorAt ?item ?door)))",
                "{0}:{1}".format(0, -1),
            ),
            ...
            (
                "(forall (?obj - Item) (Stationary ?obj))",
                "0:{}".format(self.grasp_time),
            ),
            (
                "(forall (?obs - Obstacle)(StationaryW ?obs))",
                "{}:{}".format(0, end - 1),
            ...
            (
                "(forall (?obj - Item) (not (Obstructs ?robot ?obj)))",
                "{}:{}".format(1, self.grasp_time - steps + 1),
            ),
            (
                "(forall (?obj - Item) (not (ObstructsHolding ?robot ?obj ?item)))",
                "{}:{}".format(self.grasp_time - steps + 1, end),
            ),
        ]
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    "(NearGripper{} ?robot ?item)".format(arm),
                    "{}:{}".format(self.grasp_time, self.end - 1),
                ),
                ...
                (
                    "(OpenGripper{} ?robot)".format(arm),
                    "{0}:{1}".format(1, self.grasp_time - 1),
                ),
            ]
        )
    ...
    def __init__(self, arm):
        ...
        self.eff.extend(
            [
                ...
                #   '{0}:{1}'.format(self.end, self.end-1)),
                (
                    "(forall (?reach - Reachable / ?target) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
class SlideDoor(Action):
    def __init__(self, open_door=True):
        ...
        self.pre = [
            ("(SlideDoorAt ?item ?door)", "{0}:{1}".format(0, 0)),
        ...
        if open_door:
            self.pre.append(
                ("(not (SlideDoorOpen ?item ?door))", "{0}:{1}".format(0, 0))
            )
            self.pre.append(
                ("(not (SlideDoorOpen ?item ?door))", "{0}:{1}".format(1, grasp_time))
            )
        else:
            self.pre.append(
                ("(not (SlideDoorClose ?item ?door))", "{0}:{1}".format(0, 0))
            )
            self.pre.append(
                ("(not (SlideDoorClose ?item ?door))", "{0}:{1}".format(1, grasp_time))
            )
        ...
        if open_door:
            self.eff.append(
                ("(SlideDoorOpen ?item ?door)", "{0}:{1}".format(putdown_time, end))
            )
            self.eff.append(
                (
                    "(SlideDoorAtOpen ?item ?door)",
                    "{0}:{1}".format(putdown_time, end - 1),
                )
            )
            self.eff.append(
                ("(not (SlideDoorClose ?item ?door))", "{0}:{1}".format(end, end))
            )
        else:
            self.eff.append(
                ("(SlideDoorClose ?item ?door)", "{0}:{1}".format(putdown_time, end))
            )
            self.eff.append(
                (
                    "(SlideDoorAtClose ?item ?door)",
                    "{0}:{1}".format(putdown_time, end - 1),
                )
            )
            self.eff.append(
                ("(not (SlideDoorOpen ?item ?door))", "{0}:{1}".format(end, end))
            )
    ...
    def __init__(self, arm, open_door=True):
        ...
        self.eff.extend(
            [
                ...
                (
                    "(not (InGripper{} ?robot ?item))".format(arm),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                (
                    "(forall (?obj - Reachable / ?item) \
                             (not (NearApproach{} ?robot ?obj)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
                ...
                (
                    "(NearRetreat{} ?robot ?item)".format(arm),
                    "{0}:{1}".format(self.end, self.end),
                ),
            ]
        )
...
class PlaceInDoor(Action):
    def __init__(self):
        ...
        self.pre = [
            ("(InSlideDoor ?item ?door)", "{0}:{1}".format(putdown_time, end - 1)),
            (
                "(forall (?obj - Door) (not (SlideDoorAt ?item ?obj)))",
                "{0}:{1}".format(0, -1),
            ),
    ...
    def __init__(self, arm):
        ...
        self.eff.extend(
            [
                ...
                (
                    "(forall (?reach - Reachable / ?item) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
class Stack(Action):
    def __init__(self):
        ...
        self.pre = [
            ...
            (
                "(forall (?door - Door) (not (SlideDoorAt ?base ?door)))",
                "{0}:{1}".format(0, -1),
            ),
            ...
            (
                "(AtRot ?item ?base)",
                "{0}:{1}".format(putdown_time - self.steps, end - 1),
            ),
            (
                "(forall (?obj - Item) \
                        (Stationary ?obj))",
        ...
        self.eff = [
            ("(Stacked ?item ?base)", "{}:{}".format(end, end)),
            ("(not (Lifted ?item ?robot))", "{0}:{1}".format(end, end - 1)),
            ("(not (Obstructs ?robot ?item))", "{}:{}".format(end, end - 1)),
            (
                "(forall (?obj - Item) \
    ...
    def __init__(self, arm):
        ...
        self.pre.extend(
            [
                ...
                (
                    "(not (NearApproach{} ?robot ?targ))".format(arm),
                    "{0}:{1}".format(0, -1),
                ),
        ...
        self.eff.extend(
            [
                ...
                (
                    "(forall (?reach - Reachable / ?targ) (not (NearApproach{} ?robot ?reach)))".format(
                        arm
                    ),
                    "{0}:{1}".format(self.end, self.end - 1),
                ),
...
"""write_domain(
    ...
    "project/slide_open_right.domain",
)
write_domain(
    [
        MoveToGraspRight(),
