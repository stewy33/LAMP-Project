...
from opentamp.policy_hooks.namo.door_agent import NAMODoorAgent
from opentamp.policy_hooks.namo.namo_grip_policy_solver import NAMOGripPolicySolver
import policy_hooks.namo.door_prob as prob
prob.NUM_OBJS = NUM_OBJS
prob.NUM_TARGS = NUM_TARGS
from opentamp.policy_hooks.namo.namo_motion_plan_server import NAMOMotionPlanServer
