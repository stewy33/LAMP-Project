...
from opentamp.policy_hooks.baselines.mujoco_dset import Mujoco_Dset
from opentamp.policy_hooks.agent_env_wrapper import *
...
def train(env, seed, policy_fn, reward_giver, dataset, algo,
    ...
    if algo == 'trpo':
        from opentamp.policy_hooks.baselines import trpo_mpi
        # Set up for MPI seed
