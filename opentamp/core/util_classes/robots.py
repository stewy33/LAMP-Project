...
class NAMO(Robot):
    def __init__(self):
        ...
        self.file_type = 'mjcf'
        self.radius = 0.3
        self.shape = opentamp.__path__[0]+'/robot_info/lidar_namo.xml'
...
class TwoLinkArm(Robot):
    def __init__(self):
        ...
        self.file_type = 'mjcf'
        self.radius = 0.3
        self.shape = opentamp.__path__[0]+'/robot_info/lidar_arm.xml'
...
class Baxter(Robot):
    ...
    def __init__(self):
        self._type = "baxter"
        baxter_shape = opentamp.__path__[0] + "/robot_info/baxter_model.xml"
...
class Sawyer(Robot):
    ...
    def __init__(self):
        self._type = "sawyer"
        sawyer_shape = opentamp.__path__[0] + "/robot_info/sawyer/robot.xml"
...
class Panda(Robot):
    ...
    def __init__(self):
        self._type = "panda"
        panda_shape = opentamp.__path__[0] + "/robot_info/robodesk/panda.xml"
